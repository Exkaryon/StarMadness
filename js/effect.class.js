...
class effect {
    ...
    interaction = false;                                        // Флаг указывает, что объект не должен взаимодействовать (проверятся на столкновение) с другими объектами Вселенной, поскольку является всего лишь эффектом. 
    boundaryIgnore = true;                                      // Флаг указывающий, должен ли объект игнорировать взаимодействие с границами игрового поля.
