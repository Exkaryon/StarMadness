...
class spaceShip {
    ...
    interaction = 'physic';                                        // Свойство указывает с какие методы взаимодействия проявляет объект во Вселенной. False - объект нейтрино; all - все возможные взаимодействия; kinetic - кинетические; physic - физических параметров; boundary - пересечение границ.
    ...
    blink(){
        if(this.respawnIndication){
            if(!this.blinkTimer){                           // Если таймер индикации не установлен, устанавливается он и флаг индикации. 
                ...
                this.interaction = 'boundary';              // Во время индикации космолет недоступен для взаимодействия с другими объектами Вселенной, но реагирует на границы игрового пространства.
